	...
	SubShader
	{
		...
		Pass
		{
			...
			Varyings Vertex(Attributes input)
			{
				...
				// Texture Coordinates
				output.pack0.xy.xy = input.texcoord0.xy * _BaseMap1_ST.xy + _BaseMap1_ST.zw;
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float4 __albedo = ( tex2D(_BaseMap1, input.pack0.xy.xy).rgba );
				...
				albedo = lerp(__shadowColor, albedo, accumulatedRamp);
