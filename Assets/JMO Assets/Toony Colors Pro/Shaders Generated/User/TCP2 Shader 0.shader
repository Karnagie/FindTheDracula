...
Shader "Toony Colors Pro 2/User/TCP2 Shader 0"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		[NoScaleOffset] _Emission ("Emission Color", 2D) = "white" {}
		[TCP2Separator]
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float3 __emission = ( tex2D(_Emission, input.pack2.xy.xy).rgb );
